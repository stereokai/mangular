...
module.exports = function (grunt) {
  ...
  grunt.registerTask('serve', 'Compile then start a connect web server', function (target) {
    if (target === 'dist') {
      return grunt.task.run(['clean:dist', 'build', 'connect:dist:keepalive']);
    }
  ...
  // Re-init repository to cloned state (remove cached files as well as libraries, dependencies and devdependencies)
  grunt.registerTask('sanitize', [
    'clean:sanitize'
  ]);
